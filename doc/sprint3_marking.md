...
## Daily Stand-ups (max 10 marks)
  ...
  Standups are often late or written out of order.
...
## Documentation (max 1 mark)
  ...
  Did a quick scan, looks like there's documentation for backend work (docstrings, etc) but I couldn't find any for the frontend.
  Please let me know if there is any and I can update this!
